...
var KTDatatableRecordSelectionDemo = function() {
    ...
    var options = {
        ...
        data: {
            ...
            source: {
                read: {
                    url: BASE_URL + '/u/categories', //BASE_URL >> custom var
                    method: 'GET',
                },
                map: function (data) {
                    return data.data;
        ...
        columns: [{
            ...
            /* return '\
            <button class="btn btn-sm btn-clean btn-icon btn-icon-sm open-modal-edit" data-value="'+row.id+'" title="'+Lang.get('front-end.datatable.edit')+'"><i class="la la-edit"></i></button>\
            <button class="btn btn-sm btn-clean btn-icon btn-icon-sm open-modal-user-quizzes" data-value="'+row.id+'" title="'+Lang.get('front-end.datatable.quizzes')+'"><i class="la la-lightbulb-o"></i></button>\
            <button class="btn btn-sm btn-clean btn-icon btn-icon-sm open-modal-quick-quizzes" data-value="'+row.id+'" title="'+Lang.get('front-end.datatable.quizzes')+'"><i class="la la-lightbulb-o"></i></button>\
            ...
            return '\
                <div class="dropdown">\
                    ...
                    <div class="dropdown-menu dropdown-menu-right">\
                        ...
                        <a class="dropdown-item open-modal-user-quizzes" data-value="'+row.id+'" href="javascript:;"><i class="la flaticon-notes"></i> '+Lang.get('front-end.datatable.user_quizzes')+'</a>\
                        <a class="dropdown-item obtn-icon-sm open-modal-quick-quizzes" data-value="'+row.id+'" href="javascript:;"><i class="la flaticon-clipboard"></i> '+Lang.get('front-end.datatable.quick_quizzes')+'</a>\
    ...
    var localSelectorDemo = function() {
        ...
        $("#btn-ids").click(function (e) {
            ...
            for (var i = 0; i < ids.length; i++) {
             ...
             var url = BASE_URL + "/u/categories/deleteall";
            Swal.fire({
