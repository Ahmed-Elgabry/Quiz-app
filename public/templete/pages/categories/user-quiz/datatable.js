...
var KTDatatableRecordSelectionDemo = function() {
    ...
    var options = {
        ...
        data: {
            ...
            source: {
                read: {
                    url: BASE_URL + '/u/categories/user-quizzes/'+category_id,
                    method: 'GET',
                },
                map: function (data) {
                    return data.data;
        ...
        columns: [{
            ...
            field: 'user.username',
            title: Lang.get('front-end.userquizzes.datatable.title.username'),
            template: function(row) {
                return '<span class="kt-badge  kt-badge--info kt-badge--inline kt-badge--pill">' + row.user.username + '</span>';
            }
    ...
    var localSelectorDemo = function() {
        ...
        $("#btn-ids").click(function (e) {
            ...
            for (var i = 0; i < ids.length; i++) {
             ...
             var url = BASE_URL + "/u/usersquizzes/deleteall";
            Swal.fire({
