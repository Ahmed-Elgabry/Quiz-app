...
var KTDatatableRecordSelectionDemo = function() {
    ...
    var options = {
        ...
        data: {
            ...
            source: {
                read: {
                    url: BASE_URL + '/u/commonquestions', //BASE_URL >> custom var
                    method: 'GET',
                },
                map: function (data) {
                    return data.data;
        ...
        columns: [{
            ...
            field: 'question',
            title: Lang.get('front-end.commonquestions.datatable.title.question'),
        }, {
            field: 'is_arabic',
            title: Lang.get('front-end.commonquestions.datatable.title.language'),
        }, {
            field: 'Actions',
            ...
            template: function(row) {
	            return '\
                    <button class="btn btn-sm btn-clean btn-icon btn-icon-sm open-modal-edit" data-value="'+row.id+'" title="'+Lang.get('front-end.datatable.edit')+'">\
                        <i class="la la-edit"></i>\
                    </button>\
                    <button class="btn btn-sm btn-clean btn-icon btn-icon-sm open-modal-delete" data-value="'+row.id+'" title="'+Lang.get('front-end.datatable.delete')+'">\
    ...
    var localSelectorDemo = function() {
        ...
        $("#btn-ids").click(function (e) {
            ...
            for (var i = 0; i < ids.length; i++) {
             ...
             var url = BASE_URL + "/u/common_questions/deleteall";
            Swal.fire({
