jQuery(document).ready(function () {
    ...
    (function () {
        ...
        $("#category").select2({
            ...
            allowClear: true,
            ajax: {
                url: BASE_URL +'/u/quick-quizzes/selectCategory',
                dataType: 'json',
                delay: 250,
    ...
    jQuery('body').on('click', '.open-modal-share', function () {
        ...
        var url = BASE_URL + "/quick-quiz/share/" + quiz_slug + "/" + lang;
    ...
    jQuery('body').on('click', '.open-modal-delete', function () {
        ...
        var url = BASE_URL + "/u/quick-quizzes/delete/" + quiz_id;
    ...
    jQuery('body').on('change', '#toggleCheckbox', function () {
        var quiz_id = $(this).data('value');
        var url = BASE_URL + "/u/quick-quizzes/featured/" + quiz_id;
    ...
    jQuery('body').on('click', '.open-modal-edit-lang', function () {
        ...
        $.get('/u/quick-quizzes/show/' + id, function (data) {
...
$("#btn-edit-quiz-lang").click(function (e) {
    ...
    var ajaxurl = BASE_URL + "/u/quick-quizzes/update_lang/" + quiz_id;
...
$("#btn-edit-quiz-category").click(function (e) {
    ...
    var ajaxurl = BASE_URL + "/u/quick-quizzes/update_status/" + quiz_id;
    formData.append('_method', 'PUT');
    $.ajax({
        type: type,
        url: ajaxurl,
