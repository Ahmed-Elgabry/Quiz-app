...
var KTDatatableRecordSelectionDemo = function() {
    ...
    var options = {
        ...
        data: {
            ...
            source: {
                read: {
                    url: BASE_URL + '/u/userquiz/shown_result/'+quiz_id,
                    method: 'GET',
                },
                map: function (data) {
                    return data.data;
        ...
        columns: [{
            ...
            field: 'from',
            title: Lang.get('front-end.user.quiz.shownresult.datatable.title.from'),
        }, {
            field: 'to',
            title: Lang.get('front-end.user.quiz.shownresult.datatable.title.to'),
        }/* , {
            field: 'created_at',
    ...
    var localSelectorDemo = function() {
        ...
        $("#btn-ids").click(function (e) {
            ...
            for (var i = 0; i < ids.length; i++) {
             ...
             var url = BASE_URL + "/u/userquiz/deleteall/shown_result";
            Swal.fire({
