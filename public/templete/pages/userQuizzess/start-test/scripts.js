...
/* function getresult() {
    var guests2, message2, ans_session2;
    message2 = document.getElementById("panswer");
    message2.innerHTML = "";
    guests2 = document.getElementById("banswer").value;
    if (guests2 == null || guests2 == "") {
        message2.innerHTML = Lang.get('front-end.userQuizzess.starttest.verification');
    } else {
        ans_session2 = document.getElementById("answervalue").value;
        ...
        if (guests2 === ans_session2) {
            ...
            var quiz_id = document.getElementById("quiz_id2_").value;
            var name = document.getElementById("name_").value;
            var plocale = document.getElementById("plocale").value;
            var url = BASE_URL + "/start/"+quiz_id+"/" + name + "/" + ans_array1 + "/" + plocale;
...
function getresult() {
    ...
    if ($('input[type="checkbox"]').prop("checked") == true) {
        ...
        if (guest == null || guest == "") {
            ...
            var url = BASE_URL + "/store/" + quiz_slug + "/" + guest + "/" + ans_array1 + "/" + plocale;
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')
                }
            ...
            $.ajax({
                ...
                success: function (data) {
                    var url2 = BASE_URL + "/result/" + data.slug + "/" + plocale;
