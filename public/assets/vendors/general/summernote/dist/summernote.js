      ...
      VideoDialog.prototype.createVideoNode = function (url) {
          ...
          if (ytMatch && ytMatch[1].length === 11) {
              ...
              $video = $$1('<iframe>')
                  ...
                  .attr('width', '640').attr('height', '360').attr('class', 'embed-responsive embed-responsive-16by9 embed-responsive-item');
          }
              ...
              $video = $$1('<iframe>')
                  ...
                  .attr('scrolling', 'no')
                  .attr('class', 'embed-responsive embed-responsive-16by9 embed-responsive-item')
