    ...
    <div class="kt-container  kt-container--fluid ">
        ...
        <div class="kt-subheader__toolbar">
            <div class="kt-subheader__wrapper">
                <a href="{{ route('categories.create') }}" class="btn kt-subheader__btn-primary" title="{{ __("Create Category") }}"><i class="flaticon2-add-1"></i>{{ __("Create Category") }}</a>
            </div>
        </div>
...
@endsection
@section('js')
<script src="{{ asset('templete/pages/categories/datatable.js') }}" type="text/javascript"></script>
