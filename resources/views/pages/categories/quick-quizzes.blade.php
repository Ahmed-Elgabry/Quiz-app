        ...
        <div class="kt-subheader__main">
            ...
            <div class="kt-subheader__breadcrumbs">
                ...
                <a href="{{ route('dashboard') }}" class="kt-subheader__breadcrumbs-link">
                    {{ __('Home') }} </a>
                <span class="kt-subheader__breadcrumbs-separator"></span>
                <a href="{{ route('categories') }}" class="kt-subheader__breadcrumbs-link">
                    {{ __('Categories') }} </a>
            </div>
        </div>
    </div>
        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            <div class="kt-portlet__head-label">
                ...
                <h3 class="kt-portlet__head-title">
                    {{ __("Quick Quizzes Table") }} : {{ $category->name }}
                </h3>
            </div>
...
@endsection
@section('modals')
    @include('pages.admin.modals.edit_lang')
    @include('pages.admin.modals.edit_category')
@endsection
@section('js')
<script src="{{ asset('templete/pages/categories/quick-quiz/datatable.js') }}" type="text/javascript"></script>
<script src="{{ asset('templete/pages/categories/quick-quiz/scripts.js') }}" type="text/javascript"></script>
@endsection
