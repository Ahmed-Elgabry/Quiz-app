...
@section('title' , __("Users Quizzes"))
@section('css')
<style>
        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            <div class="kt-portlet__head-label">
                ...
                <h3 class="kt-portlet__head-title">
                    {{ __("Users Quizzes Table") }} : {{ $category->name }}
                </h3>
            </div>
...
@endsection
@section('js')
<script src="{{ asset('templete/pages/categories/user-quiz/datatable.js') }}" type="text/javascript"></script>
<script src="{{ asset('templete/pages/categories/user-quiz/scripts.js') }}" type="text/javascript"></script>
@endsection
