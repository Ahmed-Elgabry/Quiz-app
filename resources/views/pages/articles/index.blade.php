...
@section('title' , __("Articles Table"))
@section('css')
<style>
    ...
    <div class="kt-container  kt-container--fluid ">
        ...
        <div class="kt-subheader__toolbar">
            <div class="kt-subheader__wrapper">
                <a href="{{ route('articles.create') }}" class="btn kt-subheader__btn-primary">{{ __("Create Arabic Article") }} &nbsp;<i class="flaticon2-plus"></i></a>
                <a href="{{ route('articles.create_en') }}" class="btn kt-subheader__btn-primary">{{ __("Create English Article") }} &nbsp;<i class="flaticon2-plus"></i></a>
            </div>
        </div>
    </div>
</div>
...
@endsection
@section('js')
<script src="{{ asset('templete/pages/articles/datatable.js') }}" type="text/javascript"></script>
