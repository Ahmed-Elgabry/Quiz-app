        ...
        <div class="kt-subheader__main">
            ...
            <div class="kt-subheader__breadcrumbs">
                ...
                <a href="{{ route('dashboard') }}" class="kt-subheader__breadcrumbs-link">
                    {{ __('Home') }} </a>
                <span class="kt-subheader__breadcrumbs-separator"></span>
                <a href="{{ route('articles.featured') }}" class="kt-subheader__breadcrumbs-link">
                    {{ __('Featured Articles') }} </a>
            </div>
        </div>
    </div>
</div>
...
@endsection
@section('js')
<script src="{{ asset('templete/pages/articles/featured-datatable.js') }}" type="text/javascript"></script>
