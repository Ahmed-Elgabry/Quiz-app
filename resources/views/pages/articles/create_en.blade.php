...
@section('title' , __("Add English Article"))
@section('subheader')
<!-- begin:: Content Head -->
        ...
        <div class="col-lg-12">
            ...
            <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                <div class="kt-portlet__body">
                   <form id="myenCreateForm" name="myenCreateForm"  novalidate  enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-xl-2"></div>
                            <div class="col-xl-8">
                                <div class="kt-section kt-section--first">
                                    <div class="kt-section__body">
                                        <h3 class="kt-section__title kt-section__title-lg">{{ __("Add English Article") }}:</h3>
                                        <hr>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-9">
                                                <textarea type="text" rows="4" name= "content" {{-- id="summernote2" --}} value ="" class="summernote form-control @error('content') is-invalid @enderror"> {{old('content')}}</textarea>
                                                @error('content')
                                                        <p class="text-danger">{{$message}}</p>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="kt-portlet__foot">
                                        <div class="kt-form__actions">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-5">
                                                    <button type="submit" id="btn-create-ensubmit" class="btn btn-success">{{ __("Submit") }}</button>
