...
@section('title' , __("Deleted Articles"))
@section('css')
<style>
                        ...
                        <div class="kt-form__group kt-form__group--inline">
                            ...
                            <div class="kt-form__control">
                                <div class="btn-toolbar">
                                    <button class="btn btn-sm btn-success" type="button" id="restore-btn-ids">{{ __('Restore All') }}</button>
                                    &nbsp;&nbsp;&nbsp;
...
@endsection
@section('js')
<script src="{{ asset('templete/pages/articles/deleted/datatable.js') }}" type="text/javascript"></script>
<script src="{{ asset('templete/pages/articles/deleted/scripts.js') }}" type="text/javascript"></script>
@endsection
