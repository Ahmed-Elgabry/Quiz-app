...
@section('meta')
<meta property="og:title" content="{{ __('Instructions for use') }}" />
@endsection
@section('navbar')
@if(App::isLocale('ar'))
<li class="navigation-item"> <a href="{{route('terms_of_service' , ['lang'=>'en'] )}}" class="navigation-link">English</a> </li>
@else
<li class="navigation-item">  <a href="{{route('terms_of_service' , ['lang'=>'ar'] )}}" class="navigation-link">عربي</a> </li>
@endif
@endsection
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 m-auto align-center">
					...
					<h1 class="page-title text-white">{{ __('Instructions for use') }}</h1>
					<br><br>
				</div>
			</div>
		</div>
