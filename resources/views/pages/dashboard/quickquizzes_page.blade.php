...
@section('title',__("Quick Quizzes"))

@section('meta')
<meta property="og:title" content="{{ __('Quick Quizzes') }}" />
@endsection

@section('navbar')
    @if(App::isLocale('ar'))
    <li class="navigation-item"><a class="navigation-link" href="{{route('all_quickquizzes' , ['lang'=>'en'] )}}" >English</a> </li>
    @else
    <li class="navigation-item"><a class="navigation-link" href="{{route('all_quickquizzes' , ['lang'=>'ar'] )}}">عربي</a> </li>
    @endif
@endsection
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 m-auto align-center">
                    ...
                    <h1 class="page-title text-white">{{ __('Quick Quizzes') }}</h1>
...
@if($count_categories>0 || $quickquizzes_ar->count() >0 || $usersquizzes_ar->count() >0)
...
@if($count_categories>0 || $quickquizzes_en->count() >0 || $usersquizzes_en->count() >0)
    <div class="category-list-wrap">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
...
@if(App::isLocale('ar'))
            <div class="container">
                ...
                @foreach ($quickquizzes_ar as $quiz)
            ...
            <div class="row justify-content-center pagination">{{$quickquizzes_ar->links()}}</div>

            </div>
@elseif(App::isLocale('en'))
                <div class="container">
                    <div class="row sorting-container medium-section-padding" data-layout="fitRows" id="blogs-items">
                    @foreach ($quickquizzes_en as $quiz)
                    <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 mb30 sorting-item creative" data-mh="blog-item">
                        <article class="entry post post-standard has-post-thumbnail video">
                ...
                <div class="row justify-content-center pagination">{{$quickquizzes_en->links()}}</div>
