...
@section('title' , __("Users Quizzes Results"))
@section('css')
<style>
        ...
        <div class="kt-subheader__main">
            ...
            <div class="kt-subheader__breadcrumbs">
                ...
                <a href="{{ route('dashboard') }}" class="kt-subheader__breadcrumbs-link">
                    {{ __('Home') }} </a>
                <span class="kt-subheader__breadcrumbs-separator"></span>
                <a href="{{ route('usersquizzes_results') }}" class="kt-subheader__breadcrumbs-link">
                    {{ __('Users Quizzes Results') }} </a>
            </div>
        </div>
        <div class="kt-subheader__toolbar">
            <div class="kt-subheader__wrapper">
                <button class="btn kt-subheader__btn-primary open-modal-delete-all2"   title="{{ __("Delete All") }}"><i class="la flaticon-delete"></i> {{ __("Delete All") }}</button>
              </div>
        </div>
        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            <div class="kt-portlet__head-label">
                ...
                <h3 class="kt-portlet__head-title">
                    {{ __("Users Quizzes Results Table") }}
...
@endsection
@section('js')
<script src="{{ asset('templete/pages/admin/users-quiz-results/datatable.js') }}" type="text/javascript"></script>
<script src="{{ asset('templete/pages/admin/users-quiz-results/scripts.js') }}" type="text/javascript"></script>
@endsection
