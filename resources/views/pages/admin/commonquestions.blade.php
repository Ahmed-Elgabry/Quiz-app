        ...
        <div class="kt-subheader__main">
            ...
            <div class="kt-subheader__breadcrumbs">
                ...
                <a href="{{ route('dashboard') }}" class="kt-subheader__breadcrumbs-link">
                    {{ __('Home') }} </a>
                <span class="kt-subheader__breadcrumbs-separator"></span>
                <a href="{{ route('common_questions_index') }}" class="kt-subheader__breadcrumbs-link">
                    {{ __('Common Questions') }} </a>
            </div>
        </div>
        <div class="kt-subheader__toolbar">
            <div class="kt-subheader__wrapper">
                <a href="{{ route('common_questions_create') }}" class="btn kt-subheader__btn-primary">{{ __("New Record") }} &nbsp;<i class="flaticon2-plus"></i></a>
            </div>
        </div>
    </div>
</div>
...
@endsection
@section('js')
<script src="{{ asset('templete/pages/admin/settings/commonQuestions/datatable.js') }}" type="text/javascript"></script>
