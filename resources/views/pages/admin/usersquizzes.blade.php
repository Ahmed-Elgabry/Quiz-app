        ...
        <div class="kt-subheader__main">
            ...
            <div class="kt-subheader__breadcrumbs">
                ...
                <a href="{{ route('dashboard') }}" class="kt-subheader__breadcrumbs-link">
                    {{ __('Home') }} </a>
                <span class="kt-subheader__breadcrumbs-separator"></span>
                <a href="{{ route('usersquizzes') }}" class="kt-subheader__breadcrumbs-link">
                    {{ __('Users Quizzes') }} </a>
            </div>
        </div>
    </div>
...
@endsection
@section('js')
<script src="{{ asset('templete/pages/admin/user-quiz/datatable.js') }}" type="text/javascript"></script>
<script src="{{ asset('templete/pages/admin/user-quiz/scripts.js') }}" type="text/javascript"></script>
@endsection
