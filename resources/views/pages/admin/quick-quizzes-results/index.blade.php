...
@section('title' , __("Quick Quizzes Results"))
@section('css')
<style>
        ...
        <div class="kt-subheader__main">
            ...
            <div class="kt-subheader__breadcrumbs">
                ...
                <a href="{{ route('dashboard') }}" class="kt-subheader__breadcrumbs-link">
                    {{ __('Home') }} </a>
                <span class="kt-subheader__breadcrumbs-separator"></span>
                <a href="{{ route('quickquizzes_results') }}" class="kt-subheader__breadcrumbs-link">
                    {{ __('Quick Quizzes Results') }} </a>
            </div>
        </div>
        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            <div class="kt-portlet__head-label">
                ...
                <h3 class="kt-portlet__head-title">
                    {{ __("Quick Quizzes Results Table") }}
...
@endsection
@section('js')
<script src="{{ asset('templete/pages/admin/quick-quiz-results/datatable.js') }}" type="text/javascript"></script>
<script src="{{ asset('templete/pages/admin/quick-quiz-results/scripts.js') }}" type="text/javascript"></script>
@endsection
