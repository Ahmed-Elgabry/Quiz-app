...
@section('navbar')
@if(App::isLocale('ar'))
<li class="navigation-item"><a class="navigation-link"  href="{{route('quick-quiz.share_quiz' , ['slug'=>$quiz->slug,  'lang'=>'en'] )}}" >English</a></li>
@else
<li class="navigation-item"><a class="navigation-link"  href="{{route('quick-quiz.share_quiz' , ['slug'=>$quiz->slug,  'lang'=>'ar'] )}}" >عربي</a></li>
@endif
@endsection
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 mr-auto ml-auto align-center">
                ...
                <p class="fs-18 fw-medium">{{ __('this quiz created by') }} "{{ $name}}"  .</p>

                {{-- <a class="crumina-button button--dark button--l mt-4" href="#" data-toggle="modal" data-target="#modal_test">{{ __("Start Quiz") }}</a> --}}
                <a class="crumina-button button--dark button--l mt-4" @if (App::isLocale('ar')) href="{{route('quick-quiz.start_test' , ['slug'=>$quiz->slug,  'lang'=>'ar'] )}}" @else href="{{route('quick-quiz.start_test' , ['slug'=>$quiz->slug,  'lang'=>'en'] )}}" @endif>{{ __("Start Quiz") }}</a>
                <a class="crumina-button button--primary button--l mt-4" @if (App::isLocale('ar')) href="{{route('quick-quiz.get_results' , ['slug'=>$quiz->slug,  'lang'=>'ar'] )}}" @else href="{{route('quick-quiz.get_results' , ['slug'=>$quiz->slug,  'lang'=>'en'] )}}" @endif >{{ __('Results') }} </a>
