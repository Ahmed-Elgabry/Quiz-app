...
@section('title' , __("create a quick quiz"))

@section('meta')
<meta property="og:title" content="{{ __('create a quick quiz') }}">
@endsection

@section('navbar')
@if(App::isLocale('ar'))
<li class="kt-menu__item" ><a href="{{route('quick-quiz.create' , ['name'=>$name,'lang'=>'en'] )}}" class="kt-menu__link "> <span class="kt-menu__link-text">English</span></a> </li>
@else
<li class="kt-menu__item" ><a href="{{route('quick-quiz.create' , ['name'=>$name,'lang'=>'ar'] )}}" class="kt-menu__link "> <span class="kt-menu__link-text">عربي</span></a> </li>
@endif
@endsection
    ...
    <div class="kt-container  kt-container--fluid ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">
                {{ __('create a quick quiz') }} </h3>
            <span class="kt-subheader__separator kt-hidden"></span>
            <div class="kt-subheader__breadcrumbs">
                <span class="kt-subheader__breadcrumbs-separator"></span>
                <a @if(App::isLocale('ar')) href="{{route('quick-quiz.create' , ['name'=>$name,'lang'=>'ar'] )}}" @else href="{{route('quick-quiz.create' , ['name'=>$name,'lang'=>'en'] )}}" @endif class="kt-subheader__breadcrumbs-link">
                    {{ $name }} </a>
            ...
            <div class="kt-portlet__body">
                ...
                <div id="dynamic_field_m" class="question_div">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-2 col-md-9 col-sm-12">
                            <div class='input-group'>
                                <input class="form-control" name="option_weight[]" type="text" step="1" min="1" step="1" min="0" placeholder="{{ __("blank =  0") }}">
                            </div>
                ...
                <div class=" ">
                    <div class="row">
                        <div class="col-lg-9 ml-lg-auto">
                            ...
                            <input type="hidden" id="page_type" value="quick_quiz">
                ...
                <div class="kt-portlet__body">
                    <div class="kt-callout__body">
                        <div class="kt-callout__content">
                            <h3 class="kt-callout__title">{{ __('Sign Up') }}</h3>
                            <p class="kt-callout__desc">
                                {{ __('Join us, to be able to create your own quizzes with additional features and share them with whoever you want.') }}
                            </p>
                        </div>
                        <div class="kt-callout__action">
                            @if (auth()->user())
                            <a href="{{ route('dashboard') }}" class="btn btn-custom btn-bold btn-upper btn-font-sm  btn-brand">{{ __('SIGN UP') }}</a>
                            @else
                            <a href="{{ route('register') }}" class="btn btn-custom btn-bold btn-upper btn-font-sm  btn-brand">{{ __('SIGN UP') }}</a>
                            @endif
