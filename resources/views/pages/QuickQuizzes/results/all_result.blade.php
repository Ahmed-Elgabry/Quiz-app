...
@section('navbar')
@if(App::isLocale('ar'))
<li class="navigation-item"><a class="navigation-link"  href="{{route('quick-quiz.get_results' , ['slug'=>$quiz->slug,  'lang'=>'en'] )}}" >English</a></li>
@else
<li class="navigation-item"><a class="navigation-link"  href="{{route('quick-quiz.get_results' , ['slug'=>$quiz->slug,  'lang'=>'ar'] )}}" >عربي</a></li>
@endif
@endsection
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 m-auto align-center">
					...
					<h1 class="page-title text-white">{{ __('Results of') }} ( <b>{{ $quiz->quiz_name }}</b> ) {{ __('for quiz owner') }} "{{ $quiz->owner_name }}"</h1>
				</div>
			</div>
		</div>
	</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 mr-auto ml-auto align-center">
                ...
                <h2>{{ __('Results of') }} "<b>{{ $quiz->quiz_name }}</b>" {{ __('for quiz owner') }} "{{ $quiz->owner_name }}"</h2>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12 align-center mb-5 ml-auto mr-auto">
                ...
                <p class="fs-18 fw-medium">{{ __('Results of') }} "<b>{{ $quiz->quiz_name }}</b>" {{ __('for quiz owner') }} "{{ $quiz->owner_name }}".</p>
            </div>
            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12 m-auto">

                <form class="form--bordered" method="get"  @if (App::isLocale('ar')) action="{{route('quick-quiz.get_results' , ['slug'=>$quiz->slug,  'lang'=>'ar'] )}}" @else
                    action="{{route('quick-quiz.get_results' , ['slug'=>$quiz->slug,  'lang'=>'en'] )}}" @endif>
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 mr-auto ml-auto align-center">
                ...
                <footer class="entry-footer">
                        <ul class="socials socials--rounded">
                            <li><a id="facebook" @if (App::isLocale('ar')) href="{{ route('Qresults_facebook_share', ['slug'=>$quiz->slug, 'lang'=>'ar' ]) }}" @else  href="{{ route('Qresults_facebook_share', ['slug'=>$quiz->slug, 'lang'=>'en' ]) }}" @endif title="{{ __('Share it on Facebook') }}" target="_blank"><img class="crumina-icon " loading="lazy" src="{{ asset('asset1/img/theme-content/social-icons/facebook3.svg')}}" alt="facebook"></a></li>
                             <li><a id="twitter" @if (App::isLocale('ar'))  href="{{ route('Qresults_twitter_share', ['slug'=>$quiz->slug, 'lang'=>'ar' ]) }}" @else href="{{ route('Qresults_twitter_share', ['slug'=>$quiz->slug, 'lang'=>'en' ]) }}" @endif target="_blank" title="{{ __('Share it on Twitter') }}"><img class="crumina-icon " loading="lazy" src="{{ asset('asset1/img/theme-content/social-icons/twitter2.svg')}}" alt="twitter"></a></li>
                             <li><a id="whatsapp" @if (App::isLocale('ar')) href="{{ route('Qresults_whatsapp_share', ['slug'=>$quiz->slug, 'lang'=>'ar' ]) }}" @else href="{{ route('Qresults_whatsapp_share', ['slug'=>$quiz->slug, 'lang'=>'en' ]) }}" @endif target="_blank" title="{{ __('Share it on Whatsapp') }}" data-action="share/whatsapp/share" ><img class="crumina-icon " loading="lazy" src="{{ asset('asset1/img/theme-content/social-icons/whatsapp2.svg')}}" alt="whatsapp"></a></li>
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 mr-auto ml-auto mb-5 align-center">
                <div class="crumina-module crumina-info-box info-box--with-bg">
                    ...
                    <div class="info-box-content">
                        ...
                        {{--  <p class="info-box-text">Nam aliquam sem et tortor consequat id porta.</p>  --}}
