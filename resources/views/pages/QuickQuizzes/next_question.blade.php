...
@section('navbar')
@if(App::isLocale('ar'))
<li class="kt-menu__item" ><a href="{{route('quick-quiz.create_next_question' , ['slug'=>$quiz->slug,'lang'=>'en'] )}}" class="kt-menu__link "> <span class="kt-menu__link-text">English</span></a> </li>
@else
<li class="kt-menu__item" ><a href="{{route('quick-quiz.create_next_question' , ['slug'=>$quiz->slug,'lang'=>'ar'] )}}" class="kt-menu__link "> <span class="kt-menu__link-text">عربي</span></a> </li>
@endif
@endsection
    ...
    <div class="kt-container  kt-container--fluid ">
        <div class="kt-subheader__main">
            ...
            <div class="kt-subheader__breadcrumbs">
                ...
                <a @if(App::isLocale('ar')) href="{{route('quick-quiz.create_next_question' , ['slug'=>$quiz->slug,'lang'=>'ar'] )}}" @else href="{{route('quick-quiz.create_next_question' , ['slug'=>$quiz->slug,'lang'=>'en'] )}}" @endif class="kt-subheader__breadcrumbs-link">
                    {{ $quiz->owner_name }} </a>
            </div>
        </div>
    </div>
