                        ...
                        <div class="kt-form__group kt-form__group--inline">
                            ...
                            <div class="kt-form__control">
                                <div class="btn-toolbar">
                                    <button class="btn btn-sm btn-success" type="button" id="unblock-btn-ids">{{ __('unblock All') }}</button>
                                    &nbsp;&nbsp;&nbsp;
                                    <button class="btn btn-sm btn-danger" type="button" id="delete-btn-ids">{{ __('Delete All') }}</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
@endsection
@section('modals')
    @include('pages.users.modals.show_blocked')
@endsection
@section('js')
<script src="{{ asset('templete/pages/users/blocked_users/datatable.js') }}" type="text/javascript"></script>
<script src="{{ asset('templete/pages/users/blocked_users/scripts.js') }}" type="text/javascript"></script>
@endsection
