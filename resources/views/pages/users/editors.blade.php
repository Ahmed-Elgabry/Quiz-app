                        ...
                        <div class="kt-form__group kt-form__group--inline">
                            ...
                            <div class="kt-form__control">
                                <div class="btn-toolbar">
                                    <button class="btn btn-sm btn-danger" type="button" id="block-btn-ids">{{ __('Block All') }}</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
@endsection
@section('js')
<script src="{{ asset('templete/pages/users/editors/datatable.js') }}" type="text/javascript"></script>
<script src="{{ asset('templete/pages/users/editors/scripts.js') }}" type="text/javascript"></script>
@endsection
