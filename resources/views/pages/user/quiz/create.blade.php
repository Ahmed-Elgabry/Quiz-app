        ...
        <form class="kt-form kt-form--label-right" id="myCreateForm" name="myCreateForm"  novalidate  enctype="multipart/form-data">
            <div class="kt-portlet__body">
                <div class="form-group row">
                    <label class="col-form-label col-lg-3 col-sm-12">{{ __("Quiz Image") }}</label>
                    <div class="col-lg-4 col-md-9 col-sm-12 text-center">
                        <div class="kt-avatar kt-avatar--outline kt-avatar--circle-" id="kt_apps_user_add_avatar">
                            <div class="kt-avatar__holder" id="imagediv-quiz-img" style="height:100px;background-size: cover;background-image: url({{ asset('assets/media/users/default-png.png') }});"></div>
...
@endsection
@section('js')
<script src="{{ asset('templete/pages/user/quiz/create-scripts__updated.js') }}" type="text/javascript"></script>
@endsection
