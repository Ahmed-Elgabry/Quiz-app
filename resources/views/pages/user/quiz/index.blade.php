    ...
    <div class="kt-container  kt-container--fluid ">
        ...
        <div class="kt-subheader__toolbar">
            <div class="kt-subheader__wrapper">
                <a href="{{ route('user_quiz.create') }}" class="btn kt-subheader__btn-primary">{{ __("Create Quiz") }} &nbsp;<i class="flaticon2-plus"></i></a>
            </div>
    </div>
    </div>
</div>
...
@endsection
@section('modals')
    @include('pages.user.quiz.modals.try')
@endsection
@section('js')
<script src="{{ asset('templete/pages/user/quiz/datatable.js') }}" type="text/javascript"></script>
<script src="{{ asset('templete/pages/user/quiz/scripts__updated.js') }}" type="text/javascript"></script>
@endsection
