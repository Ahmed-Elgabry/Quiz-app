...
@section('navbar')
@if(App::isLocale('ar'))
<li class="navigation-item"> <a href="{{route('user-quiz.start_test' , ['slug'=>$quiz->slug , 'lang'=>'en'] )}}"class="navigation-link">English</a> </li>
@else
<li class="navigation-item"> <a href="{{route('user-quiz.start_test' , ['slug'=>$quiz->slug , 'lang'=>'en'] )}}" class="navigation-link">عربي</a> </li>
@endif
@endsection
...
<section class="large-section-padding">
    ...
    <div id ="tag_container" class="container">
        @include('pages.userQuizzess.start.start-test-ajax')
...
<script src="{{ asset('templete/pages/userQuizzess/start-test/_scripts.js') }}" type="text/javascript"></script>
@endsection
