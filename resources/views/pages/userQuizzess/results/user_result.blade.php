...
@section('navbar')
@if(App::isLocale('ar'))
<li class="navigation-item"><a class="navigation-link" href="{{route('user-quiz.get_result' , ['answer_slug'=>$answer->slug,'lang'=>'en'] )}}">English</a></li>
@else
<li class="navigation-item"><a class="navigation-link" href="{{route('user-quiz.get_result' , ['answer_slug'=>$answer->slug,'lang'=>'ar'] )}}">عربي</a></li>
@endif
@endsection
        ...
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 mr-auto ml-auto align-center">
                ...
                <p class="fs-18 fw-medium">{{ __('Your Result is : ') }} <b> <br>{{ $answer->results }} </b> {{ __('from') }} <b> {{ $quiz->grade }}.</p>
                    ...
                    @if ($quiz->hide_result_counter == "مفعل" || $quiz->hide_result_counter == "Activated")
                        @php
                ...
                <a class="crumina-button button--yellow button--l mt-4" @if (App::isLocale('ar')) href="{{route('user-quiz.get_results' , ['slug'=>$quiz->slug,  'lang'=>'ar'] )}}" @else href="{{route('user-quiz.get_results' , ['slug'=>$quiz->slug,  'lang'=>'en'] )}}" @endif>{{ __('Results') }} </a>
                ...
                @else
                    ...
                    @if (($quiz->hide_result_counter == "مقفل" || $quiz->hide_result_counter == "Locked") && (!$text) && ($quiz->hide_survey_result== "مخفية" || $quiz->hide_survey_result== "Hidden"))
                    <br>
                    <p class="fs-18 fw-medium">{{ __('you can not able to see your result until the owner of the quiz authorizes it!') }}</p>
                    <br>
                    @endif
                ...
                <br>
                @if (App::isLocale('ar'))
                <a class="crumina-button button--dark button--xxl button--uppercase button--bordered mt-4" href="{{route('user-quiz.share_quiz' , ['slug'=>$quiz->slug,  'lang'=>'ar'] )}}">{{ __('Back to Quiz') }}</a>
                @else
                <a class="crumina-button button--dark button--xxl button--uppercase button--bordered mt-4" href="{{route('user-quiz.share_quiz' , ['slug'=>$quiz->slug,  'lang'=>'en'] )}}">{{ __('Back to Quiz') }}</a>
                @endif
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 mr-auto ml-auto align-center">
                ...
                <footer class="entry-footer">
                    <ul class="socials socials--rounded">
                        <li><a id="facebook" @if (App::isLocale('ar')) href="{{ route('Uquizresult_facebook_share', ['answer_slug'=>$answer->slug ,'lang'=>'ar' ]) }}" @else href="{{ route('Uquizresult_facebook_share', ['answer_slug'=>$answer->slug , 'lang'=>'en' ]) }}" @endif title="{{ __('Share it on Facebook') }}" target="_blank"><img class="crumina-icon " loading="lazy" src="{{ asset('asset1/img/theme-content/social-icons/facebook3.svg')}}" alt="facebook"></a></li>
                        <li><a id="twitter" @if (App::isLocale('ar')) href="{{ route('Uquizresult_twitter_share', ['answer_slug'=>$answer->slug ,'lang'=>'ar' ]) }}" @else href="{{ route('Uquizresult_twitter_share', ['answer_slug'=>$answer->slug, 'lang'=>'en' ]) }}" @endif target="_blank" title="{{ __('Share it on Twitter') }}"><img class="crumina-icon " loading="lazy" src="{{ asset('asset1/img/theme-content/social-icons/twitter2.svg')}}" alt="twitter"></a></li>
                        <li><a id="whatsapp" @if (App::isLocale('ar')) href="{{ route('Uquizresult_whatsapp_share', ['answer_slug'=>$answer->slug,'lang'=>'ar' ]) }}" @else href="{{ route('Uquizresult_whatsapp_share', ['answer_slug'=>$answer->slug, 'lang'=>'en' ]) }}" @endif target="_blank" title="{{ __('Share it on Whatsapp') }}" data-action="share/whatsapp/share"><img class="crumina-icon " loading="lazy" src="{{ asset('asset1/img/theme-content/social-icons/whatsapp2.svg')}}" alt="whatsapp"></a></li>
...
{{--  <section>
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 crumina-promo-block bg-dark-themes align-center">
                ...
                <a @if(App::isLocale('ar')) <a href="{{route('contact' , ['lang'=>'ar'] )}}" @else <a href="{{route('contact' , ['lang'=>'en'] )}}" @endif class="crumina-button button--yellow button--l mt-4">{{ __('LET’S CONTACT') }}</a>
            </div>
            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 crumina-promo-block bg-yellow-themes align-center">
                ...
                <h2>{{ __('JOIN US') }}</h2>
                <p class="fs-18 fw-medium">{{ __('Join us. you’ll create your own Quizzes and share with whoever you want.') }}</p>
...
<script type="text/javascript">
    ...
    document.getElementById("copy_input2").value = decodeURI("{{ URL::to('/') }}/share/" + quiz_slug + "/" + plocale, "_self");
</script>
